...
public class FrmCadVendas extends JDialog {
	...
	private void btnCadastrarActionPerformed(ActionEvent e) {
		...
		try {
			ven.getDadosParaVenda(cpfCli, codProd, quantidadeItens);
			txtCodProd.setText("");
	...
	public void attTable() {
		try {
			...
			while (rs.next()) {
				tb.addRow(new Object[] { rs.getInt("codVenda"), rs.getString("cpfCli"), rs.getString("nomeCli"),
						rs.getInt("codProd"), rs.getString("nomeProd"), rs.getDouble("precoProd"),
						rs.getInt("quantidadeItens"), rs.getDouble("totalVenda")
			...
			// ======== scrollPane1 ========
			{
				...
				tbVenda.setModel(new DefaultTableModel(
						new Object[][] { { null, null, null, null, "", "", "", null },
								...
								{ null, null, null, null, null, null, null, null },
								{ null, null, null, null, null, null, null, null }, },
						new String[] { "C\u00d3D. VENDA", "CPF CLIENTE", "NOME ", "COD. PRODUTO", "NOME PRODUTO",
								"PRE\u00c7O", "QUANTIDADE", "TOTAL" }) {
					boolean[] columnEditable = new boolean[] { true, false, true, true, true, true, true, true };
